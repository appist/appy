...
func (s *DBConfigSuite) SetupTest() {
	s.logger, s.buffer, s.writer = NewFakeLogger()
	s.support = &Support{}
}

func (s *DBConfigSuite) TestParseDBConfigWithBadConfig() {
...
func (s *DBConfigSuite) TestParseDBConfigWithMultipleURIs() {
...
func (s *DBConfigSuite) TestParseDBConfigForMySQL() {
...
func (s *DBConfigSuite) TestParseDBConfigForPostgreSQL() {
	os.Setenv("DB_CONN_MAX_LIFETIME_PRIMARY", "10m")
	os.Setenv("DB_MAX_IDLE_CONNS_PRIMARY", "50")
	os.Setenv("DB_MAX_OPEN_CONNS_PRIMARY", "100")
	os.Setenv("DB_REPLICA_PRIMARY", "true")
