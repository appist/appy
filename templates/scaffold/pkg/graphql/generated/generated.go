...
type ComplexityRoot struct {
	Mutation struct {
		AddTodo func(childComplexity int, description string, username string) int
	}
	...
	Subscription struct {
		TodoAdded func(childComplexity int, username string) int
	}
...
type MutationResolver interface {
	AddTodo(ctx context.Context, description string, username string) (*model.Todo, error)
}
type QueryResolver interface {
	Todos(ctx context.Context) ([]*model.Todo, error)
}
type SubscriptionResolver interface {
	TodoAdded(ctx context.Context, username string) (<-chan *model.Todo, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.addTodo":
		...
		return e.complexity.Mutation.AddTodo(childComplexity, args["description"].(string), args["username"].(string)), true
	...
	case "Subscription.todoAdded":
		...
		args, err := ec.field_Subscription_todoAdded_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Subscription.TodoAdded(childComplexity, args["username"].(string)), true
...
var sources = []*ast.Source{
	&ast.Source{Name: "pkg/graphql/schema/mutation.gql", Input: `type Mutation {
  """
  Add a new todo.
  """
  addTodo(description: String!, username: String!): Todo!
}
`, BuiltIn: false},
	&ast.Source{Name: "pkg/graphql/schema/query.gql", Input: `type Query {
  """
  List the tasks.
  """
  todos: [Todo!]!
...
`, BuiltIn: false},
	&ast.Source{Name: "pkg/graphql/schema/scalar.gql", Input: `scalar Time
`, BuiltIn: false},
	&ast.Source{Name: "pkg/graphql/schema/subscription.gql", Input: `type Subscription {
  """
...
`, BuiltIn: false},
	&ast.Source{Name: "pkg/graphql/schema/type.gql", Input: `"""
...
func (ec *executionContext) field_Subscription_todoAdded_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 string
	if tmp, ok := rawArgs["username"]; ok {
...
func (ec *executionContext) _Mutation_addTodo(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return ec.resolvers.Mutation().AddTodo(rctx, args["description"].(string), args["username"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Subscription_todoAdded(ctx context.Context, field graphql.CollectedField) (ret func() graphql.Marshaler) {
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	rawArgs := field.ArgumentMap(ec.Variables)
	args, err := ec.field_Subscription_todoAdded_args(ctx, rawArgs)
	if err != nil {
		ec.Error(ctx, err)
		return nil
	}
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Subscription().TodoAdded(rctx, args["username"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return nil
