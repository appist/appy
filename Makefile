benchmark\:diff:
	cob --base origin/master --threshold 0.2 --bench-args "test -run=NONE -bench . -benchmem -benchtime 8s -failfast ./..."

benchmark\:pack:
	go test -run=NONE -bench . -benchmem -benchtime 8s -failfast ./pack

benchmark\:record:
	go test -run=NONE -bench . -benchmem -benchtime 8s -failfast ./record
