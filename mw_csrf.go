...
func getCSRFTokenFromCookie(ctx *Context, config *Config) ([]byte, error) {
...
func getCSRFTokenFromRequest(ctx *Context, config *Config) []byte {
	r := ctx.Request
...
func saveCSRFTokenIntoCookie(token []byte, ctx *Context, config *Config) error {
