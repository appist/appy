...
import (
	...
	"github.com/appist/appy/http/sessionstore"
...
// SessionMngr is a middleware that provides the session management functionality.
func SessionMngr(config *support.Config) HandlerFunc {
