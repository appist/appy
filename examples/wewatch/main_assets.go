...
var assets = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2019, 10, 10, 15, 47, 56, 981714219, time.UTC),
		},
		"/.ssr": &vfsgen۰DirInfo{
			name:    ".ssr",
			modTime: time.Date(2019, 10, 10, 15, 47, 56, 983693484, time.UTC),
		},
		"/.ssr/locales": &vfsgen۰DirInfo{
			name:    "locales",
			modTime: time.Date(2019, 10, 10, 15, 47, 56, 984373257, time.UTC),
		},
		"/.ssr/locales/en.yml": &vfsgen۰CompressedFileInfo{
			name:             "en.yml",
			modTime:          time.Date(2019, 10, 10, 15, 47, 56, 984021546, time.UTC),
		...
		"/.ssr/locales/zh-CN.yml": &vfsgen۰CompressedFileInfo{
			name:             "zh-CN.yml",
			modTime:          time.Date(2019, 10, 10, 15, 47, 56, 984252553, time.UTC),
		...
		"/.ssr/locales/zh-TW.yml": &vfsgen۰CompressedFileInfo{
			name:             "zh-TW.yml",
			modTime:          time.Date(2019, 10, 10, 15, 47, 56, 984474497, time.UTC),
			uncompressedSize: 183,
		...
		"/.ssr/views": &vfsgen۰DirInfo{
			name:    "views",
			modTime: time.Date(2019, 10, 10, 15, 47, 56, 983161052, time.UTC),
		},
		"/.ssr/views/layouts": &vfsgen۰DirInfo{
			name:    "layouts",
			modTime: time.Date(2019, 10, 10, 15, 47, 56, 982049505, time.UTC),
		},
		"/.ssr/views/layouts/default.html": &vfsgen۰CompressedFileInfo{
			name:             "default.html",
			modTime:          time.Date(2019, 10, 10, 15, 47, 56, 982203989, time.UTC),
		...
		"/.ssr/views/shared": &vfsgen۰DirInfo{
			name:    "shared",
			modTime: time.Date(2019, 10, 10, 15, 47, 56, 982818994, time.UTC),
		},
		"/.ssr/views/shared/footer.html": &vfsgen۰FileInfo{
			name:    "footer.html",
			modTime: time.Date(2019, 10, 10, 15, 47, 56, 982711819, time.UTC),
		...
		"/.ssr/views/shared/header.html": &vfsgen۰FileInfo{
			name:    "header.html",
			modTime: time.Date(2019, 10, 10, 15, 47, 56, 982936628, time.UTC),
		...
		"/.ssr/views/welcome": &vfsgen۰DirInfo{
			name:    "welcome",
			modTime: time.Date(2019, 10, 10, 15, 47, 56, 983315904, time.UTC),
		},
		"/.ssr/views/welcome/index.html": &vfsgen۰FileInfo{
			name:    "index.html",
			modTime: time.Date(2019, 10, 10, 15, 47, 56, 983480275, time.UTC),
