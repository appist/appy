...
var assets = func() http.FileSystem {
	fs := vfsgen۰FS{
		...
		"/.ssr/locales/en.yml": &vfsgen۰CompressedFileInfo{
			name:             "en.yml",
			modTime:          time.Date(2019, 10, 5, 14, 7, 0, 869515296, time.UTC),
		...
		"/.ssr/locales/zh-CN.yml": &vfsgen۰CompressedFileInfo{
			name:             "zh-CN.yml",
			modTime:          time.Date(2019, 10, 5, 14, 7, 0, 869818071, time.UTC),
		...
		"/.ssr/locales/zh-TW.yml": &vfsgen۰CompressedFileInfo{
			name:             "zh-TW.yml",
			modTime:          time.Date(2019, 10, 5, 14, 7, 0, 870086428, time.UTC),
			uncompressedSize: 183,
		...
		"/.ssr/views/layouts/default.html": &vfsgen۰CompressedFileInfo{
			name:             "default.html",
			modTime:          time.Date(2019, 10, 5, 14, 7, 0, 866421311, time.UTC),
		...
		"/.ssr/views/shared/footer.html": &vfsgen۰FileInfo{
			name:    "footer.html",
			modTime: time.Date(2019, 10, 5, 14, 7, 0, 868195979, time.UTC),
		...
		"/.ssr/views/shared/header.html": &vfsgen۰FileInfo{
			name:    "header.html",
			modTime: time.Date(2019, 10, 5, 14, 7, 0, 868577617, time.UTC),
		...
		"/.ssr/views/welcome/index.html": &vfsgen۰FileInfo{
			name:    "index.html",
			modTime: time.Date(2019, 10, 5, 14, 7, 0, 868995881, time.UTC),
