...
var assets = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2019, 10, 4, 7, 52, 36, 357710245, time.UTC),
		},
		"/.ssr": &vfsgen۰DirInfo{
			name:    ".ssr",
			modTime: time.Date(2019, 10, 3, 15, 55, 27, 651160458, time.UTC),
		},
		"/.ssr/locales": &vfsgen۰DirInfo{
			name:    "locales",
			modTime: time.Date(2019, 10, 3, 15, 55, 27, 651717180, time.UTC),
		},
		"/.ssr/locales/en.yml": &vfsgen۰CompressedFileInfo{
			name:             "en.yml",
			modTime:          time.Date(2019, 10, 4, 7, 58, 35, 788525499, time.UTC),
		...
		"/.ssr/locales/zh-CN.yml": &vfsgen۰CompressedFileInfo{
			name:             "zh-CN.yml",
			modTime:          time.Date(2019, 10, 4, 7, 58, 35, 788814139, time.UTC),
		...
		"/.ssr/locales/zh-TW.yml": &vfsgen۰CompressedFileInfo{
			name:             "zh-TW.yml",
			modTime:          time.Date(2019, 10, 4, 7, 58, 35, 789111849, time.UTC),
			uncompressedSize: 183,
		...
		"/.ssr/views": &vfsgen۰DirInfo{
			name:    "views",
			modTime: time.Date(2019, 10, 3, 15, 55, 27, 650497498, time.UTC),
		},
		"/.ssr/views/layouts": &vfsgen۰DirInfo{
			name:    "layouts",
			modTime: time.Date(2019, 10, 3, 15, 55, 27, 649767520, time.UTC),
		},
		"/.ssr/views/layouts/default.html": &vfsgen۰CompressedFileInfo{
			name:             "default.html",
			modTime:          time.Date(2019, 10, 4, 7, 58, 35, 787409841, time.UTC),
		...
		"/.ssr/views/shared": &vfsgen۰DirInfo{
			name:    "shared",
			modTime: time.Date(2019, 10, 3, 15, 55, 27, 650305127, time.UTC),
		},
		"/.ssr/views/shared/footer.html": &vfsgen۰FileInfo{
			name:    "footer.html",
			modTime: time.Date(2019, 10, 4, 7, 58, 35, 787739867, time.UTC),
		...
		"/.ssr/views/shared/header.html": &vfsgen۰FileInfo{
			name:    "header.html",
			modTime: time.Date(2019, 10, 4, 7, 58, 35, 787924506, time.UTC),
		...
		"/.ssr/views/welcome": &vfsgen۰DirInfo{
			name:    "welcome",
			modTime: time.Date(2019, 10, 3, 15, 55, 27, 650685779, time.UTC),
		},
		"/.ssr/views/welcome/index.html": &vfsgen۰FileInfo{
			name:    "index.html",
			modTime: time.Date(2019, 10, 4, 7, 58, 35, 788191339, time.UTC),
		...
		"/index.html": &vfsgen۰CompressedFileInfo{
			name:             "index.html",
			modTime:          time.Date(2019, 10, 4, 7, 58, 28, 322479822, time.UTC),
			uncompressedSize: 581,

			compressedContent: []byte(""),
		},
	}
