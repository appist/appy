...
var assets = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2019, 10, 6, 18, 22, 22, 440038313, time.UTC),
		},
		"/.ssr": &vfsgen۰DirInfo{
			name:    ".ssr",
			modTime: time.Date(2019, 10, 6, 18, 22, 22, 444532784, time.UTC),
		},
		"/.ssr/locales": &vfsgen۰DirInfo{
			name:    "locales",
			modTime: time.Date(2019, 10, 6, 18, 22, 22, 445253405, time.UTC),
		},
		"/.ssr/locales/en.yml": &vfsgen۰CompressedFileInfo{
			name:             "en.yml",
			modTime:          time.Date(2019, 10, 6, 18, 22, 22, 444900224, time.UTC),
		...
		"/.ssr/locales/zh-CN.yml": &vfsgen۰CompressedFileInfo{
			name:             "zh-CN.yml",
			modTime:          time.Date(2019, 10, 6, 18, 22, 22, 445151484, time.UTC),
		...
		"/.ssr/locales/zh-TW.yml": &vfsgen۰CompressedFileInfo{
			name:             "zh-TW.yml",
			modTime:          time.Date(2019, 10, 6, 18, 22, 22, 445380743, time.UTC),
			uncompressedSize: 183,
		...
		"/.ssr/views": &vfsgen۰DirInfo{
			name:    "views",
			modTime: time.Date(2019, 10, 6, 18, 22, 22, 443914556, time.UTC),
		},
		"/.ssr/views/layouts": &vfsgen۰DirInfo{
			name:    "layouts",
			modTime: time.Date(2019, 10, 6, 18, 22, 22, 440451136, time.UTC),
		},
		"/.ssr/views/layouts/default.html": &vfsgen۰CompressedFileInfo{
			name:             "default.html",
			modTime:          time.Date(2019, 10, 6, 18, 22, 22, 440941692, time.UTC),
		...
		"/.ssr/views/shared": &vfsgen۰DirInfo{
			name:    "shared",
			modTime: time.Date(2019, 10, 6, 18, 22, 22, 443522831, time.UTC),
		},
		"/.ssr/views/shared/footer.html": &vfsgen۰FileInfo{
			name:    "footer.html",
			modTime: time.Date(2019, 10, 6, 18, 22, 22, 443019747, time.UTC),
		...
		"/.ssr/views/shared/header.html": &vfsgen۰FileInfo{
			name:    "header.html",
			modTime: time.Date(2019, 10, 6, 18, 22, 22, 443711545, time.UTC),
		...
		"/.ssr/views/welcome": &vfsgen۰DirInfo{
			name:    "welcome",
			modTime: time.Date(2019, 10, 6, 18, 22, 22, 444137010, time.UTC),
		},
		"/.ssr/views/welcome/index.html": &vfsgen۰FileInfo{
			name:    "index.html",
			modTime: time.Date(2019, 10, 6, 18, 22, 22, 444299545, time.UTC),
