...
var assets = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2019, 10, 3, 15, 55, 27, 649482865, time.UTC),
		},
		"/.ssr": &vfsgen۰DirInfo{
			name:    ".ssr",
		...
		"/.ssr/locales/en.yml": &vfsgen۰CompressedFileInfo{
			name:             "en.yml",
			modTime:          time.Date(2019, 10, 3, 16, 33, 44, 971414238, time.UTC),
		...
		"/.ssr/locales/zh-CN.yml": &vfsgen۰CompressedFileInfo{
			name:             "zh-CN.yml",
			modTime:          time.Date(2019, 10, 3, 16, 33, 44, 971823924, time.UTC),
		...
		"/.ssr/locales/zh-TW.yml": &vfsgen۰CompressedFileInfo{
			name:             "zh-TW.yml",
			modTime:          time.Date(2019, 10, 3, 16, 33, 44, 972195504, time.UTC),
			uncompressedSize: 183,
		...
		"/.ssr/views/layouts/default.html": &vfsgen۰CompressedFileInfo{
			name:             "default.html",
			modTime:          time.Date(2019, 10, 3, 16, 33, 44, 968994284, time.UTC),
		...
		"/.ssr/views/shared/footer.html": &vfsgen۰FileInfo{
			name:    "footer.html",
			modTime: time.Date(2019, 10, 3, 16, 33, 44, 969836945, time.UTC),
		...
		"/.ssr/views/shared/header.html": &vfsgen۰FileInfo{
			name:    "header.html",
			modTime: time.Date(2019, 10, 3, 16, 33, 44, 970253076, time.UTC),
		...
		"/.ssr/views/welcome/index.html": &vfsgen۰FileInfo{
			name:    "index.html",
			modTime: time.Date(2019, 10, 3, 16, 33, 44, 970810503, time.UTC),
