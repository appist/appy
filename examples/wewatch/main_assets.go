...
var assets = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2019, 10, 5, 13, 18, 39, 450805947, time.UTC),
		},
		"/.ssr": &vfsgen۰DirInfo{
			name:    ".ssr",
			modTime: time.Date(2019, 10, 5, 13, 18, 39, 452379353, time.UTC),
		},
		"/.ssr/locales": &vfsgen۰DirInfo{
			name:    "locales",
			modTime: time.Date(2019, 10, 5, 13, 18, 39, 452958776, time.UTC),
		},
		"/.ssr/locales/en.yml": &vfsgen۰CompressedFileInfo{
			name:             "en.yml",
			modTime:          time.Date(2019, 10, 5, 13, 18, 39, 452642943, time.UTC),
		...
		"/.ssr/locales/zh-CN.yml": &vfsgen۰CompressedFileInfo{
			name:             "zh-CN.yml",
			modTime:          time.Date(2019, 10, 5, 13, 18, 39, 452863433, time.UTC),
		...
		"/.ssr/locales/zh-TW.yml": &vfsgen۰CompressedFileInfo{
			name:             "zh-TW.yml",
			modTime:          time.Date(2019, 10, 5, 13, 18, 39, 453095352, time.UTC),
			uncompressedSize: 183,
		...
		"/.ssr/views": &vfsgen۰DirInfo{
			name:    "views",
			modTime: time.Date(2019, 10, 5, 13, 18, 39, 451887377, time.UTC),
		},
		"/.ssr/views/layouts": &vfsgen۰DirInfo{
			name:    "layouts",
			modTime: time.Date(2019, 10, 5, 13, 18, 39, 451089602, time.UTC),
		},
		"/.ssr/views/layouts/default.html": &vfsgen۰CompressedFileInfo{
			name:             "default.html",
			modTime:          time.Date(2019, 10, 5, 13, 18, 39, 451218152, time.UTC),
		...
		"/.ssr/views/shared": &vfsgen۰DirInfo{
			name:    "shared",
			modTime: time.Date(2019, 10, 5, 13, 18, 39, 451681841, time.UTC),
		},
		"/.ssr/views/shared/footer.html": &vfsgen۰FileInfo{
			name:    "footer.html",
			modTime: time.Date(2019, 10, 5, 13, 18, 39, 451595588, time.UTC),
		...
		"/.ssr/views/shared/header.html": &vfsgen۰FileInfo{
			name:    "header.html",
			modTime: time.Date(2019, 10, 5, 13, 18, 39, 451772880, time.UTC),
		...
		"/.ssr/views/welcome": &vfsgen۰DirInfo{
			name:    "welcome",
			modTime: time.Date(2019, 10, 5, 13, 18, 39, 452046088, time.UTC),
		},
		"/.ssr/views/welcome/index.html": &vfsgen۰FileInfo{
			name:    "index.html",
			modTime: time.Date(2019, 10, 5, 13, 18, 39, 452204439, time.UTC),
